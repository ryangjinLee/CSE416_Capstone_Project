      ...
      map.setFeatureState(
        {
          source: source,
          id:
            feature.districtNumber != null
              ? feature.districtNumber - 1
              : feature.id,
        },
        {
          hover: false,
    ...
    if (this.props.DisplayDistricts) {
      ...
      if (hoveredFeature != undefined) {
        let featureToHighlight =
          this.props.CurrentDistrictingSummary.districtSummaries.find(
            (summary) => summary.districtNumber == hoveredFeature.id + 1
          );
          ...
          <div className="iconAndLabel">
            ...
            <span onClick={(e) => (e) => this.props.setInSelectionMenu(true)}>
              {this.props.CurrentDistrictingGeoJson != null
                ? this.props.CurrentDistrictingGeoJson.name != null
                  ? this.props.CurrentDistrictingGeoJson.name
                  : this.props.CurrentDistrictingGeoJson.id
                : "Loading districting..."}
            </span>
          </div>
        </div> */}
          ...
          <div
            className={
              this.props.JobLoaded
                ? "viewAndFilterDistrictingsOption"
                : "disabledViewAndFilterDistrictingsOption"
            }
            onClick={(e) => {
            ...
            {this.props.PrecinctsGeoJson != null ? (
              <div>
                ...
                <Layer
                  ...
                  source={MapUtilities.IDs.PRECINCT_SOURCE_ID}
                  layout={{
                    visibility: this.props.DisplayPrecincts
                      ? "visible"
                      : "none",
                  }}
                  paint={{
            ...
            {this.props.CurrentDistrictingGeoJson != null ? (
              <div>
                ...
                <Layer
                  ...
                  layout={{
                    visibility: this.props.DisplayDistricts
                      ? "visible"
                      : "none",
                  }}
                  paint={{
